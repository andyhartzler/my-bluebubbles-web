...
export 'package:bluebubbles/database/io/contact.dart'
    if (dart.library.html) 'package:bluebubbles/database/html/contact.dart';
...
export 'package:bluebubbles/database/io/fcm_data.dart'
    if (dart.library.html) 'package:bluebubbles/database/html/fcm_data.dart';
export 'package:bluebubbles/database/io/handle.dart'
    if (dart.library.html) 'package:bluebubbles/database/html/handle.dart';
...
export 'package:bluebubbles/objectbox.g.dart'
    if (dart.library.html) 'package:bluebubbles/database/html/objectbox.dart' hide Version;
...
export 'package:bluebubbles/database/io/theme_entry.dart'
    if (dart.library.html) 'package:bluebubbles/database/html/theme_entry.dart';
export 'package:bluebubbles/database/io/theme_object.dart'
    if (dart.library.html) 'package:bluebubbles/database/html/theme_object.dart';
export 'package:bluebubbles/database/io/giphy.dart'
    if (dart.library.html) 'package:bluebubbles/database/html/giphy.dart';
