...
/// Screen for executives to configure workspace settings including:
/// - Workspace enabled/disabled toggle for member access
/// - Member tools configuration
class CommitteeWorkspaceSettingsScreen extends StatefulWidget {
  final Committee committee;

  const CommitteeWorkspaceSettingsScreen({
    super.key,
    required this.committee,
  });

  @override
  State<CommitteeWorkspaceSettingsScreen> createState() =>
      _CommitteeWorkspaceSettingsScreenState();
}

class _CommitteeWorkspaceSettingsScreenState
    extends State<CommitteeWorkspaceSettingsScreen> {
  ...
  Widget _buildContent() {
    ...
    return Column(
      children: [
        // Header section with committee info
        Container(
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Configure workspace access and member tools',
        ...
        Expanded(
          child: ListView(
            ...
            children: [
              ...
              // Member Tools Section (only visible if workspace is enabled)
  ...
  Widget _buildWorkspaceToggle() {
    return Card(
      elevation: _workspaceEnabled ? 3 : 0,
      color: _workspaceEnabled ? Colors.white : Colors.grey.shade100,
