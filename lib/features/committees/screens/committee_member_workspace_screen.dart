  ...
  Widget _buildLeaderChip(CommitteeLeader leader) {
    return Container(
      ...
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          // Opaque unityBlue disc, not a translucent white fill: this chip
          // sits on the unityBlue to momentumBlue gradient, where white on
          // white-30% measures 2.01:1. The opaque default is 12.51:1.
          CorsAwareAvatar(
