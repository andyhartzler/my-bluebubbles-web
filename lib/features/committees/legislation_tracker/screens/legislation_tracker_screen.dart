            ...
            children: [
              ...
              if (_showFilters)
                BillFilters(
                  ...
                  sponsorFilter: provider.sponsorFilter,
                  searchQuery: provider.searchQuery,
                  showArchived: provider.showArchived,
                  searchBillText: provider.searchBillText,
                  categories: provider.categories,
                  sponsors: provider.uniqueSponsors,
                  ...
                  onSponsorChanged: (v) => provider.setSponsorFilter(v),
                  onSearchChanged: (v) => provider.setSearchQuery(v),
                  onShowArchivedChanged: (v) => provider.setShowArchived(v),
                  onSearchBillTextChanged: (v) => provider.setSearchBillText(v),
