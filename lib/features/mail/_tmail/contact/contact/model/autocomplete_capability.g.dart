...
AutocompleteCapability _$AutocompleteCapabilityFromJson(
  ...
  minInputLength: const UnsignedIntNullableConverter().fromJson(
    (json['minInputLength'] as num?)?.toInt(),
  ),
);
...
Map<String, dynamic> _$AutocompleteCapabilityToJson(
  ...
  'minInputLength': ?const UnsignedIntNullableConverter().toJson(
    instance.minInputLength,
  ),
};
