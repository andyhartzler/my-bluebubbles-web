...
_CustomQuestion _$CustomQuestionFromJson(Map<String, dynamic> json) =>
    _CustomQuestion(
      ...
      type:
          $enumDecodeNullable(_$CustomQuestionTypeEnumMap, json['type']) ??
...
_Job _$JobFromJson(Map<String, dynamic> json) => _Job(
  ...
  resumeEnabled: const SafeNullableBoolConverter().fromJson(
    json['resume_enabled'],
  ),
  resumeRequired: const SafeNullableBoolConverter().fromJson(
    json['resume_required'],
  ),
  coverLetterEnabled: const SafeNullableBoolConverter().fromJson(
    json['cover_letter_enabled'],
  ),
  coverLetterRequired: const SafeNullableBoolConverter().fromJson(
    json['cover_letter_required'],
  ),
...
Map<String, dynamic> _$JobToJson(_Job instance) => <String, dynamic>{
  ...
  'resume_enabled': const SafeNullableBoolConverter().toJson(
    instance.resumeEnabled,
  ),
  'resume_required': const SafeNullableBoolConverter().toJson(
    instance.resumeRequired,
  ),
  'cover_letter_enabled': const SafeNullableBoolConverter().toJson(
    instance.coverLetterEnabled,
  ),
  'cover_letter_required': const SafeNullableBoolConverter().toJson(
    instance.coverLetterRequired,
  ),
  'references_enabled': const SafeBoolConverter().toJson(
    instance.referencesEnabled,
  ),
  'references_required': const SafeBoolConverter().toJson(
    instance.referencesRequired,
  ),
  'references_count': instance.referencesCount,
  'use_external_apply': const SafeBoolConverter().toJson(
    instance.useExternalApply,
  ),
};
