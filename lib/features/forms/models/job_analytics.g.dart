...
_JobMemberInteraction _$JobMemberInteractionFromJson(
  ...
  totalIdleTimeSeconds: (json['total_idle_time_seconds'] as num?)?.toInt() ?? 0,
  totalActiveTimeSeconds:
      (json['total_active_time_seconds'] as num?)?.toInt() ?? 0,
  externalApplyClicks: (json['external_apply_clicks'] as num?)?.toInt() ?? 0,
  ...
  devicesUsed:
      (json['devices_used'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  browsersUsed:
      (json['browsers_used'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
