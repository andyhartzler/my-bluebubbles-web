...
_VotingForm _$VotingFormFromJson(Map<String, dynamic> json) => _VotingForm(
  ...
  oneSubmissionPerUser: json['one_submission_per_user'] == null
      ? true
      : const SafeBoolTrueConverter().fromJson(json['one_submission_per_user']),
...
Map<String, dynamic> _$VotingFormToJson(
  _VotingForm instance,
) => <String, dynamic>{
  'id': instance.id,
  ...
  'results_public': const SafeBoolConverter().toJson(instance.resultsPublic),
  ...
  'one_submission_per_user': const SafeBoolTrueConverter().toJson(
    instance.oneSubmissionPerUser,
  ),
  ...
  'executive_only': const SafeBoolConverter().toJson(instance.executiveOnly),
