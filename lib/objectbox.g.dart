  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    ...
    Message: obx_int.EntityDefinition<Message>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final dateReadDbValue = const fb.Int64Reader().vTableGetNullable(
          buffer,
          rootOffset,
          104,
        );
        final dateDeliveredDbValue = const fb.Int64Reader().vTableGetNullable(
          buffer,
          rootOffset,
          106,
        );
        final dateEditedDbValue = const fb.Int64Reader().vTableGetNullable(
          buffer,
          rootOffset,
          108,
        );
...
class Message_ {
  ...
  static final dateReadDb = obx.QueryDateProperty<Message>(
    _entities[5].properties[40],
  );

  /// See [Message.dateDeliveredDb].
  static final dateDeliveredDb = obx.QueryDateProperty<Message>(
    _entities[5].properties[41],
  );

  /// See [Message.dateEditedDb].
  static final dateEditedDb = obx.QueryDateProperty<Message>(
